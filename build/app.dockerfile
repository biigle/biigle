...
RUN php composer.phar config repositories.projects vcs https://github.com/BiodataMiningGroup/biigle-projects \
    ...
    && sed -i '/Insert Biigle module service providers/a Biigle\\Modules\\Projects\\ProjectsServiceProvider::class,' config/app.php \
...
RUN php composer.phar config repositories.label-trees vcs https://github.com/BiodataMiningGroup/biigle-label-trees \
    ...
    && sed -i '/Insert Biigle module service providers/a Biigle\\Modules\\LabelTrees\\LabelTreesServiceProvider::class,' config/app.php \
...
RUN php composer.phar config repositories.volumes vcs https://github.com/BiodataMiningGroup/biigle-volumes \
    ...
    && sed -i '/Insert Biigle module service providers/a Biigle\\Modules\\Volumes\\VolumesServiceProvider::class,' config/app.php \
...
RUN php composer.phar config repositories.annotations vcs https://github.com/BiodataMiningGroup/biigle-annotations \
    ...
    && sed -i '/Insert Biigle module service providers/a Biigle\\Modules\\Annotations\\AnnotationsServiceProvider::class,' config/app.php \
...
RUN php composer.phar config repositories.largo vcs https://github.com/BiodataMiningGroup/biigle-largo \
    ...
    && sed -i '/Insert Biigle module service providers/a Biigle\\Modules\\Largo\\LargoServiceProvider::class,' config/app.php \
...
RUN php composer.phar config repositories.export vcs https://github.com/BiodataMiningGroup/biigle-export \
    ...
    && sed -i '/Insert Biigle module service providers/a Biigle\\Modules\\Export\\ExportServiceProvider::class,' config/app.php \
...
RUN php composer.phar config repositories.geo vcs https://github.com/BiodataMiningGroup/biigle-geo \
    ...
    && sed -i '/Insert Biigle module service providers/a Biigle\\Modules\\Geo\\GeoServiceProvider::class,' config/app.php \
...
RUN php composer.phar config repositories.color-sort vcs https://github.com/BiodataMiningGroup/biigle-color-sort \
    ...
    && sed -i '/Insert Biigle module service providers/a Biigle\\Modules\\ColorSort\\ColorSortServiceProvider::class,' config/app.php \
...
RUN php composer.phar config repositories.laserpoints vcs https://github.com/BiodataMiningGroup/biigle-laserpoints \
    ...
    && sed -i '/Insert Biigle module service providers/a Biigle\\Modules\\Laserpoints\\LaserpointsServiceProvider::class,' config/app.php \
...
RUN php composer.phar config repositories.ananas vcs https://github.com/BiodataMiningGroup/biigle-ananas \
    ...
    && sed -i '/Insert Biigle module service providers/a Biigle\\Modules\\Ananas\\AnanasServiceProvider::class,' config/app.php \
